 ...
 */
export const WEDDING_DATE = dayjs.tz("2026-08-29 13:40", "Asia/Seoul")
 ...
 * 예식 장소 명칭
 */
export const LOCATION = "아이벡스 컨벤션"

/**
 * 예식 장소 상세 주소
 */
export const LOCATION_ADDRESS = "경기도 광명시 양지로 17 AK플라자 광명점 5층"
...
// 신부 정보 설정
export const BRIDE_FULLNAME = "김서현"
export const BRIDE_FIRSTNAME = "서현"
export const BRIDE_TITLE = "장녀"
export const BRIDE_FATHER = "김대홍"
export const BRIDE_MOTHER = "김미경"
...
// 신랑 정보 설정
export const GROOM_FULLNAME = "박윤수"
export const GROOM_FIRSTNAME = "윤수"
export const GROOM_TITLE = "차남"
export const GROOM_FATHER = "박태식"
export const GROOM_MOTHER = "성숙진"
